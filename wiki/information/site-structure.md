...
├── mctrade/index.html           # one folder per project page
├── styles/
...
Adding a project page means adding a folder with its own `index.html`, and linking it from
the homepage's navigation blocks.
